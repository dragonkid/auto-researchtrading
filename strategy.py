...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Smooth vol-adaptive cap (was: piecewise with discontinuity at vol_ratio=1.2)
            _vol_factor = max(0.0, min(1.0, (vol_ratio - MAX_COMBINED_VOL_LOW) / (MAX_COMBINED_VOL_HIGH - MAX_COMBINED_VOL_LOW)))
            _cap_base = MAX_COMBINED_MULT_LOW_VOL - (MAX_COMBINED_MULT_LOW_VOL - MAX_COMBINED_MULT_HIGH_VOL) * _vol_factor
