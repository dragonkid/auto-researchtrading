...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed triple-source confluence amplifier
            # (was max +50% scaling of _confluence_adj when EMA slope sign agreed with
            # ret_long sign). The base _confluence_adj already captures slope*trend_avg
            # confluence; the amplifier added correlated cross-timescale dependency on
            # the same trend signals, amplifying coordinated noise at trend boundaries.
            # Removes 4 lines and one cross-coupling.
