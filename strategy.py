...
PORT_DD_GIVEBACK_TIGHTEN = 0.40   # max fractional reduction of giveback at deep DD (raised from 0.30: v2.2 doubly rewards DD reduction via dd_gate+calmar return_reward, shifting optimal magnitude above v2.1's 0.30; step1 rally gain +0.0128 is 2.3x crash loss -0.0055 so larger mag grows composite)
