...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Branch step 4: even deeper relaxation in high-trend (rally) by -0.15 at rsi_trend_str=1.
            _strong_min = STRONG_WEIGHT_MIN + 0.20 * (1.0 - rsi_trend_str) - 0.15 * rsi_trend_str
