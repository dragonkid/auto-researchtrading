    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: removed profit-magnitude giveback amplifier.
                # The amplifier coupled giveback ratio to absolute profit, but pp_activation
                # already gates pp firing at low peaks; the amplification was a redundant
                # second-order modulation introducing noise correlation between peak_pnl
                # and giveback computation. Removing simplifies the pp-pressure path.
