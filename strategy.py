...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Linreg-based medium trend (uses all 16 bars, more noise-robust than endpoint return)
            _linreg_trend = _lr.slope * LINREG_PERIOD
            _med_weight = TREND_GATE_MED_WEIGHT_SIDEWAYS - (TREND_GATE_MED_WEIGHT_SIDEWAYS - TREND_GATE_MED_WEIGHT_BASE) * cooldown_trend_strength
            trend_avg = _med_weight * _linreg_trend + (1.0 - _med_weight) * ret_long
