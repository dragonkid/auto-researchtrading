...
PORT_VOL_AVG_ONSET = 0.90  # branch step15: 0.95->0.90 at 45pct mag (engage more crash-bounce bars without bull penalty)
PORT_VOL_AVG_SCALE = 0.20
PORT_VOL_AVG_MAX_SHRINK = 0.45  # branch step13: 40->45 with sustain (push to cross +0.003 keep)
