...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed 2-bar isolated-spike penalty.
            # The EMA-based secondary admission gate (_bull_ema/_bear_ema below)
            # already filters single-bar conviction spikes via recent-buildup
            # check. Removing the redundant 2-bar history mechanism eliminates
            # correlated state (both used same _bull_strong/_bear_strong inputs).
