...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # 2-bar average of smoothed close as numerator (halves single-bar noise sensitivity)
            _smooth_curr = (smoothed_closes[-1] + smoothed_closes[-2]) * 0.5
            ret_vshort = (_smooth_curr - _med_ref_short) / _med_ref_short
            ret_short = (_smooth_curr - _med_ref_med) / _med_ref_med
