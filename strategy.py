...
CROSS_ASSET_TREND_DECAY = 0.10     # slower decay preserves boost in moderate trends
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            cross_asset_decay = min(abs(ret_long) / CROSS_ASSET_TREND_DECAY, 1.0)
            dampened_cross_agree = 1.0 + (cross_asset_agree - 1.0) * (1.0 - cross_asset_decay)
