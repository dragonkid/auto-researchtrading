...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            bullish = bull_votes >= MIN_VOTES and ((trend_bull and bull_votes >= bear_votes) or (abs(trend_avg) < TREND_GATE_DEADZONE and bull_votes > bear_votes))
            bearish = bear_votes >= MIN_VOTES and ((trend_bear and bear_votes >= bull_votes) or (abs(trend_avg) < TREND_GATE_DEADZONE and bear_votes > bull_votes))
