    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                _fv = 3 if vol_ratio > 1.5 else FLIP_MIN_VOTES
                if not in_cooldown and ((current_pos > 0 and bear_votes >= _fv and trend_avg < 0) or (current_pos < 0 and bull_votes >= _fv and trend_avg > 0)):
