    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # The _pp_activation smooth ramp ([0.95, 1.04] band on _pp_ratio) already
                # provides profit-magnitude gating; the tanh amplifier was a separate
                # tuning layer that may be redundant.
