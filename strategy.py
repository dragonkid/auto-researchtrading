...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Use smoothed_closes for EMA cross (fast EMA span=3 is highly noise-sensitive on raw closes)
            ...
            # Use smoothed_closes for RSI differences (reduces single-bar noise sensitivity)
