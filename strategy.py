...
ENTRY_INITIAL_FRAC = 0.35  # first bar: 35% of target (smaller initial = less noise-driven PnL)
ENTRY_FULL_BARS = 1  # reach full position in 1 bar (faster scale-up compensates smaller initial)
