...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            smoothed_close = (closes[-1] + closes[-2]) * 0.5
            ret_vshort = (smoothed_close - closes[-SHORT_WINDOW]) / closes[-SHORT_WINDOW]
            ret_short = (smoothed_close - closes[-adaptive_med]) / closes[-adaptive_med]
            ret_med = (smoothed_close - closes[-MED2_WINDOW]) / closes[-MED2_WINDOW]
