...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # EMA cross uses smoothed_closes for noise immunity (raw close -> smoothed -> EMA)
            ...
            # RSI uses smoothed_closes for noise immunity
            ...
            # MACD also uses smoothed_closes for noise immunity
