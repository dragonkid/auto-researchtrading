...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Multi-bar endpoint for momentum (3-bar mean reduces single-point noise by sqrt(3))
            # Architectural: voters use aggregated endpoint instead of single observation
            _endpoint_avg = np.mean(smoothed_closes[-3:])
