    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                self._exit_press_ema[symbol] = _pp_smooth = (0.85 + 0.15 * max(0.0, min(1.0, (vol_ratio - 0.7) / 0.3))) * _pp_pressure + (1.0 - 0.85 - 0.15 * max(0.0, min(1.0, (vol_ratio - 0.7) / 0.3))) * self._exit_press_ema.get(symbol, _pp_pressure)
