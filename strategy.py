    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0:
                ...
                flip_votes_req = FLIP_MIN_VOTES + 1 if abs(ret_long) < 0.03 else FLIP_MIN_VOTES
                flip_bearish = bear_votes >= flip_votes_req and trend_bear
                flip_bullish = bull_votes >= flip_votes_req and trend_bull
