"""
Exp214: Reduce STOP_FLAT_TREND_BOOST 0.35->0.20 to tighten sideways stop widening.
In sideways markets, stops are currently widened up to 35% — this may allow losing
positions to run too long, especially in crash_bear where false sideways signals
occur before further legs down. Tightening to 20% should reduce losses in adverse
conditions and improve cross-regime consistency (lower std).
"""
...
STOP_FLAT_TREND_BOOST = 0.20    # max stop widening when trend is near zero
