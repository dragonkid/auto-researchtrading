    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: removed 2D vol-time exit_thresh modulator (_vt_factor).
                # The scale-in winning ramp already provides bar-count exit protection;
                # the additional vol-band * mid-life modulation was a 2D piece adding
                # complexity without orthogonality to existing pp/time pressure structure.
