...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            vshort_trend_adapt = min(abs(ret_long) / 0.06, 1.0)
            vshort_mult = 0.5 + 0.15 * (1.0 - vshort_trend_adapt)
            vshort_bull = ret_vshort > dyn_threshold * vshort_mult
            vshort_bear = ret_vshort < -dyn_threshold * vshort_mult
