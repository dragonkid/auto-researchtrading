    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: removed _scale_in_w bars_held attenuator.
                # Scale-in protection is already handled by _scale_in_winning exit_thresh raise
                # and ramp-attn pnl gate; double-protecting via slope/pp weight attenuation
                # was redundant and over-cushioning.
