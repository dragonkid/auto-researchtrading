...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # EMA cross from HL2 for voter decorrelation (HL2 receives ~50% perturbation, multi-point EMA aggregation)
            ...
            # EMA slope from HL2 for noise decorrelation (22-period EMA is multi-point aggregation)
            _hl2_slope = (bd.history["high"].values[-(EMA_SLOPE_PERIOD + EMA_SLOPE_LOOKBACK + 5):] + bd.history["low"].values[-(EMA_SLOPE_PERIOD + EMA_SLOPE_LOOKBACK + 5):]) / 2.0
            _ea = ema(_hl2_slope, EMA_SLOPE_PERIOD)
