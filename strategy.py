        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0:
                ...
                if pos_pnl > adaptive_profit_thresh:
                    profit_blend = min(RSI_EXIT_PROFIT_TIGHTEN * (1.0 + 0.50 * min(1.0, max(0.0, (0.72 - vol_ratio) / 0.15))), (pos_pnl - adaptive_profit_thresh) * RSI_EXIT_PROFIT_SCALE / max(0.6, min(1.8, vol_ratio)))
