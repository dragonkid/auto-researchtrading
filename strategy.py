...
# Vote / cooldown (5 voters: ret_vshort + EMA_cross removed for noise reduction)
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # 5 voters (EMA cross removed: EMA_FAST=3 gives 50% weight to current bar = direct noise)
            _voter_deltas_bull = [
