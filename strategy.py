...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            _rsi_raw_period = 6 + 2 * rsi_trend_str
            _rsi_lower = int(_rsi_raw_period)
            _rsi_blend = _rsi_raw_period - _rsi_lower
            rsi = (1 - _rsi_blend) * calc_rsi(closes, _rsi_lower) + _rsi_blend * calc_rsi(closes, min(_rsi_lower + 1, 8))
