...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Vol-adaptive smoothing: heavier in calm (alpha=0.40), lighter in choppy (alpha=0.55)
            # Reduces current-bar noise contribution to ret_short/ret_vshort voter inputs
            _smooth_alpha = 0.40 + 0.15 * max(0.0, min(1.0, (vol_ratio - 0.7) / 0.5))
