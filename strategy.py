    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: removed voter_bias from exit
                # pressure (-25 LOC, removes 4 nested tanh gates, 3 cross-component
                # data dependencies). voter_bias coupled the voter subsystem (strong-sum
                # margins) to the exit subsystem, creating correlated noise: voter
                # oscillation in rally pullbacks directly drives exit oscillation.
                # Exit decisions now depend only on direct market-observable pressures
                # (slope, pp, time, ve, ep, ar, sl) — decoupled from voter opinion.
                _voter_bias = 0.0
