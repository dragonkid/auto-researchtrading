...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed _xa_boost post-cap chop boost.
            # The post-cap +8% chop-only sizing was added on top of combined_mult cap.
            # Hypothesis: this small sizing modulator is largely redundant with
            # cross-asset boost already inside combined_mult AND sideways_boost (which
            # also activates in chop). Removing reduces correlated sizing pressure.
