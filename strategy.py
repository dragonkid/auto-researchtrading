...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Branch step 5: step 3 (rally relax -0.10) + steeper sideways tightening (+0.25 instead of +0.20).
            _strong_min = STRONG_WEIGHT_MIN + 0.25 * (1.0 - rsi_trend_str) - 0.10 * rsi_trend_str
