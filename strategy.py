        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                if current_pos > 0 and rsi > effective_ob:
                    if not (pos_pnl > 0 and vol_ratio < 0.8 and rsi < effective_ob + 1.0 and _lr.slope > 0):
                        target = 0.0
                elif current_pos < 0 and rsi < effective_os:
                    if not (pos_pnl > 0 and vol_ratio < 0.8 and rsi > effective_os - 1.0 and _lr.slope < 0):
                        target = 0.0
