"""
Exp370: Power-dampen cross_trend_strength in cross-asset boost dampening.
Currently linear: min(abs(ret_long) / CROSS_ASSET_TREND_DECAY, 1.0).
Applying ^0.85 makes the cross-asset agreement boost persist longer into
moderate trends, keeping the diversification benefit active in transition zones
between sideways and trending markets.
"""
