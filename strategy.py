# Exp: Lower vshort threshold multiplier 0.50->0.35 for more sensitive short-term momentum voter.
import numpy as np
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            vshort_bull = ret_vshort > dyn_threshold * 0.35
            vshort_bear = ret_vshort < -dyn_threshold * 0.35
