...
PORT_CONC_LOSS_ONSET = 0.50    # fraction of other-held positions in loss above which shrink engages (0.5 = majority losing)
PORT_CONC_LOSS_SCALE = 0.25    # tanh saturation scale (0.50 -> 0.75 saturates)
PORT_CONC_LOSS_MAX_SHRINK = 0.20  # max first-bar shrink at full concurrent-loss (-> 0.80x)
