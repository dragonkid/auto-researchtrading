    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Total exit pressure with vol-adaptive threshold: low vol -> higher threshold
                # (less likely to exit on partial pressure sums in rally) -> rally noise buffer.
                _exit_pressure = _sl_pressure + _sl_slope_pressure + _pp_pressure + _time_pressure
                _exit_thresh = 1.0 + 0.10 * max(0.0, min(1.0, (0.7 - vol_ratio) / 0.4))
