...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # The base 2-source confluence (_lr.slope * trend_avg) already captures
            # cross-window agreement. Adding EMA slope + ret_long as a third sign-product
            # added two more cross-bar data dependencies whose marginal signal is dominated
            # by AST-seed perturbation. Simpler entry-size formula tests whether the
            # amplifier was load-bearing or noise.
