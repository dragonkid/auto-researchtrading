    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: 6-cycle temporal compound → 2-cycle (TOD × DOW).
                # MOM/QUARTER/SEMI/YEAR cycles were added without independent validation;
                # TOD+DOW was the validated keep (2bc413c, +0.000556 composite). Removing
                # 4 unvalidated cycles reduces temporal overfitting risk and simplifies
                # the entry size modulator. TOD peaks at UTC 16 (US session), DOW peaks
                # Wed/Thu. Multiplicative compound preserves the [0.85, 1.15] range.
