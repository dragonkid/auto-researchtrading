...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed trade-frequency self-regulator.
            # The strong-sum gate already filters by conviction; recent entry density
            # is correlated with conviction-rich windows, so the +0..20%% admission
            # tightening on top of strong-sum was correlated noise on the same signal.
            # Removing eliminates one feedback loop and reduces LOC.
