    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Flip mechanism (votes + trend_avg sign + vote dominance, vol-scaled, confidence-sized)
                # Vote-dominance gate: opposing votes must EXCEED same-direction votes
                # This blocks ambiguous flips where both sides are high (noise-sensitive)
