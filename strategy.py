...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            ema_narrow_dampen = min(1.0, 0.85 + 1.5 * ema_spread)
            ...
            combined_mult = vol_scale * strength_scale * calm_boost * sideways_boost * dampened_cross_agree * vote_boost * vol_confirm_mult * ema_narrow_dampen
            ...
            if current_pos == 0:
                ...
                if symbol in self.entry_prices:
                    ...
                    if pos_pnl > adaptive_profit_thresh:
                        ...
                        calm_tighten_boost = max(0.0, (0.65 - vol_ratio) / 0.15) if vol_ratio < 0.65 else 0.0
