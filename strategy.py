...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed vol_confirm_mult factor from the size cascade.
            # Volume-derived multiplier was a noise channel: raw close-bar volume ratio is highly
            # noisy and feeds linearly into size. Eliminating it removes a multiplicative noise
            # term whose information content is already partially captured by realized_vol.
