    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: removed _profit_magnitude
                # amplification of _giveback_ratio. The smooth pp_activation
                # ramp [0.95, 1.04] already gates pp_pressure on peak meaningfulness;
                # additional profit-magnitude scaling on giveback may be redundant
                # cross-correlation between activation and amplitude (both driven
                # by peak_pnl/_pp_min ratio).
