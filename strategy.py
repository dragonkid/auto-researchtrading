...
LINREG_R2_SIZE_BOOST = 0.25     # max position size boost when linreg R² is high (clean trend)
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            r2_boost = 1.0 + LINREG_R2_SIZE_BOOST * linreg_r2
            combined_mult = vol_scale * strength_scale * calm_boost * sideways_boost * dampened_cross_agree * vote_boost * vol_compress_boost * vol_confirm_mult * r2_boost
