...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed Kaufman ER deep-chop suppression.
            # The ER gate attenuated _entry_frac_dyn below ER<0.15, but rally has
            # frequent micro-chop within sustained trends — the gate misfired in
            # trending regimes. Voter strong-sum + trend_gate already filter
            # noise-driven entries; ER was redundant on net.
