...
class Strategy:
    def __init__(self):
        ...
        self._smoothed_pnl = {}
        self._prev2_pnl = {}
        # Last-side memory for entry hysteresis
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural: vol-adaptive voter signal normalization (sqrt vol_ratio).
            ...
            _rally_sig = max(0.0, min(1.0, (1.05 - vol_ratio) / 0.45)) * max(0.0, min(1.0, rsi_trend_str / 0.45))
            _strong_min = STRONG_WEIGHT_MIN + 0.20 * (1.0 - rsi_trend_str) + 0.16 * _rally_sig
            ...
            if abs(target - current_pos) > 1.0:
                ...
                if target == 0:
                    ...
                    self.prev_voter_signals[symbol + "_lastside"] = 1 if current_pos > 0 else -1
