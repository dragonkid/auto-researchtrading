...
MEANREV_RSI_OVERSOLD = 44  # widened from 49: reduce noise sensitivity near neutral RSI
MEANREV_RSI_OVERBOUGHT = 56  # widened from 51: require stronger RSI signal for meanrev
