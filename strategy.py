    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Narrow boundary smoothing only: linear ramp in [0.96, 1.06]*_pp_min.
                # Slightly shifted upward to capture the bull boost while preserving baseline
                # binary outside band.
                ...
                if _pp_ratio <= 0.96:
                    ...
                    _pp_activation = (_pp_ratio - 0.96) / 0.10
