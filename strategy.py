    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Flip mechanism disabled: each flip is a noise-sensitive decision (vote threshold + trend sign)
                # Removing flips eliminates the noisiest position change path entirely
                # Positions now exit via slope/peak-profit/decay, then re-enter from flat
                pass
