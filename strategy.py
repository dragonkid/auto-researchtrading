    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                # Architectural simplification: removed vol-conditioned _w_pp amplification.
                # The vol-gated profit-side boost (max +20% in high-vol crash) duplicated work
                # already done by _profit_magnitude * _pm_trend_atten amplification on _giveback_ratio
                # and _pp_activation binary gate. Both mechanisms tighten pp-trailing in profitable
                # positions — adding _w_pp boost on top compounds the same signal pathway. Simplify
                # to _w_pp = _scale_in_w (matches _scale_in_w pattern used by other soft pressures).
                _w_pp    = _scale_in_w
