...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural simplification: removed post-cap _xa_boost chop-only sizing lift.
            # The combined_mult already includes chop-favored components (calm_boost,
            # sideways_boost, cross-asset boost — all favor low-trend) which the cap
            # already absorbs. The additional 1.0+0.08*chop_gate post-cap multiplier
            # was redundant for chop regimes and added a noise-coupled size channel.
