...
CROSS_ASSET_FIXED_BOOST = 0.15  # legacy constant kept for reference
LINREG_R2_MULT_BASE = 0.85
LINREG_R2_MULT_SCALE = 0.30
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            _r2_mult = LINREG_R2_MULT_BASE + LINREG_R2_MULT_SCALE * max(0.0, min(1.0, _lr.rvalue ** 2))
            combined_mult = max(0.3, min(2.5, (TARGET_VOL / realized_vol) ** 0.85)) * strength_scale * calm_boost * sideways_boost * _r2_mult * HIGH_VOTE_BOOST_MULT * vol_confirm_mult
