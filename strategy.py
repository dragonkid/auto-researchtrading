...
# Sizing multipliers
BASE_POSITION_SIZE = 0.0640  # increased from 0.0595 to compensate removed boosts
CALM_BOOST_MAX = 0.8
...
ENTRY_GATE_FLOOR = 0.40  # reduced floor: smaller boundary positions = less noise sensitivity
