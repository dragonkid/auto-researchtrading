...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            vol_breakout_bull = vb_short > realized_vol * 1.08 and ret_vshort > dyn_threshold * 0.20
            vol_breakout_bear = vb_short > realized_vol * 1.08 and ret_vshort < -dyn_threshold * 0.20
