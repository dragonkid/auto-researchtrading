...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            confirming_bull = linreg_bull or slope_bull or donchian_bull
            confirming_bear = linreg_bear or slope_bear or donchian_bear
            bullish = bull_votes >= MIN_VOTES and confirming_bull and (trend_bull or (abs(trend_avg) < TREND_GATE_DEADZONE and bull_votes > bear_votes))
            bearish = bear_votes >= MIN_VOTES and confirming_bear and (trend_bear or (abs(trend_avg) < TREND_GATE_DEADZONE and bear_votes > bull_votes))
