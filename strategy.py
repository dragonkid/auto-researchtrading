...
# RSI exit parameters
RSI_EXIT_HL2_BLEND = 0.30  # fraction of HL2-RSI in exit blend (0=close only, 1=HL2 only)
RSI_OVERBOUGHT = 73
RSI_OVERSOLD = 27
RSI_OB_TIGHT = 65
RSI_OS_TIGHT = 35
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Blended RSI for exits: partial HL2 component for noise reduction
            hl2_series = (bd.history["high"].values + bd.history["low"].values) * 0.5
            rsi_exit = (1.0 - RSI_EXIT_HL2_BLEND) * rsi + RSI_EXIT_HL2_BLEND * calc_rsi(hl2_series, rsi_period)
