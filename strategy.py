...
SIZE_QUANT_STEP = 0.005  # Quantize size fraction to 0.5pct equity steps (noise-immune sizing)
CALM_BOOST_MAX = 0.8
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            size = equity * (round(BASE_POSITION_SIZE * combined_mult / SIZE_QUANT_STEP) * SIZE_QUANT_STEP)
