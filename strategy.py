...
STRONG_WEIGHT_MIN = 1.50  # required sum of margin-above-0.5 voter contributions (EXP5: rescaled 1.75*6/7 for 6 voters)
MIN_VOTES = 2.50  # EXP5: rescaled 2.92*6/7 for 6 voters
FLIP_MIN_VOTES = 2.40  # EXP5: rescaled 2.80*6/7 for 6 voters
COOLDOWN_BARS = 1
...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            # Architectural (EXP5): remove the 7th VWAP voter (6 voters), thresholds
            # rescaled 7->6 to preserve admission level. Inverse of EXP3/4: tests whether
            # the most-recent volume-based voter is load-bearing or — like the OBV add —
            # inert on the voter-saturated strong regimes.
            _voter_signals_bull = [
