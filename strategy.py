    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                if not in_cooldown and ((current_pos > 0 and _lr.slope < -FLIP_LINREG_THRESHOLD and trend_avg < 0) or (current_pos < 0 and _lr.slope > FLIP_LINREG_THRESHOLD and trend_avg > 0)):
