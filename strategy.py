...
ENTRY_GATE_SCALE = 0.40  # how quickly sizing grows above threshold (wider = smoother transition)
ENTRY_GATE_FLOOR = 0.38  # minimum sizing fraction at exactly MIN_VOTES
