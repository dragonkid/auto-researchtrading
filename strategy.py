"""
Exp343: Increase RSI_EXIT_PROFIT_TIGHTEN 0.15->0.18 for higher ceiling on
profit-scaled RSI exit tightening. With RSI_EXIT_PROFIT_SCALE now at 20
(much higher than original 12), the tighten ceiling may be the binding
constraint. Raising it allows bigger RSI exit tightening at high profit,
locking in gains faster on big winners.
"""
