...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            adaptive_cap = max(MAX_COMBINED_MULT_HIGH_VOL, MAX_COMBINED_MULT_LOW_VOL - 3.0 * max(0.0, (vol_ratio - MAX_COMBINED_VOL_LOW) / (MAX_COMBINED_VOL_HIGH - MAX_COMBINED_VOL_LOW)))
