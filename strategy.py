...
HOLD_DECAY_START = 5   # bars after which exit pressure begins (faster to reduce divergent hold time)
HOLD_DECAY_RATE = 0.25  # exit pressure per bar beyond start (0.25 = exit at bar 9 with no momentum)
MOMENTUM_HOLD_BONUS = 1  # max extra bars when slope strongly agrees (tighter for stability)
STOP_LOSS_PCT = -0.024
