...
class Strategy:
    ...
    def on_bar(self, bar_data, portfolio):
        ...
        # via the _port_deep_bear_mag signal. In deep-bear, sharp moves are trend-continuation
        # (profitable for shorts) -> cap off -> crash byte-identical. In non-deep-bear regimes
        # (bull/rally/sideways), sharp moves are pullbacks/mean-reversion -> cap fires. The
        # gate ramps the cap's shrink to 0 as deep-bear engages (continuous, no boundary).
        ...
        _port_spot_move_cap = 1.0 - _port_spot_move_shrink * (1.0 - _port_deep_bear_spot_gate)
