    ...
    def on_bar(self, bar_data, portfolio):
        ...
        for symbol in ACTIVE_SYMBOLS:
            ...
            if current_pos == 0 and not in_cooldown:
                ...
                _tp_shape_k = 1.0 + 1.0 * max(0.0, np.tanh((vol_ratio - 0.6) / 0.4))  # 1.0 calm -> 2.0 high-vol (step5: shape-gate onset 0.8->0.6 engage crash vol_ratio earlier; width onset stays 0.8 byte-identical window)
