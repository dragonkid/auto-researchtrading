...
You run **up to 5 independent experiments** in the exploration phase, plus **one exploration branch up to 10 steps deep** (independent budget). Total session ceiling = 15 experiments.
